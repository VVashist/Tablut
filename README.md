# Tablut :
Developed Java based game ‘Tablut’, an ancestor of Chess involving 0-2 human players. The game could be automated using 
the AI bot to play against itself or a human. The AI applied an alpha-beta pruning and minimax algorithm-based game tree approach.
Link : http://www-inst.eecs.berkeley.edu/~cs61b/fa19/materials/proj/proj2/index.html
